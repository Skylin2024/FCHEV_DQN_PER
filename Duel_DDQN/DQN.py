...
class DQN_agent(object):
	...
	def save(self,dir,algo,EnvName,episode):
		torch.save(self.q_net.state_dict(), "./{}/{}_{}_{}.pth".format(dir,algo,EnvName,int(episode)))

	def load(self,dir,algo,EnvName,episode):
		self.q_net.load_state_dict(torch.load("./{}/{}_{}_{}.pth".format(dir,algo,EnvName,int(episode))))
		self.q_target.load_state_dict(torch.load("./{}/{}_{}_{}.pth".format(dir,algo,EnvName,int(episode))))


class ReplayBuffer(object):
	def __init__(self, state_dim, dvc, max_size=int(1e5)):
